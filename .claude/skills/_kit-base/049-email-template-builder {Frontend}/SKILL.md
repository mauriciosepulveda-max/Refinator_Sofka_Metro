...
description: Responsive HTML email templates. Table-based layout, inline CSS, 600px max-width. Firebase Extensions trigger.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [frontend, email, responsive, template]
---
# email-template-builder {Frontend} (v1.0)
> **"Ship pixels that perform, accessible by default."**
## Purpose
Responsive HTML email templates. Table-based layout, inline CSS, 600px max-width. Firebase Extensions trigger.
