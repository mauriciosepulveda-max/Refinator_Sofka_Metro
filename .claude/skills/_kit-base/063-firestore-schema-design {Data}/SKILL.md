...
description: Document/collection design. Embedding vs subcollections. Composite indexes. TTL fields. Collection group queries.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [data, firestore, schema, indexes]
---
# firestore-schema-design {Data} (v1.0)
> **"Data is the product. Model it for queries, secure it with rules, back it up daily."**
## Purpose
Document/collection design. Embedding vs subcollections. Composite indexes. TTL fields. Collection group queries.
