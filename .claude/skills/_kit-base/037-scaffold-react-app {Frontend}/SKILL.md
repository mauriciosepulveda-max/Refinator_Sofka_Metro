...
description: React 19+ project with Firebase integration. Routing (React Router v7), Auth context, Firestore hooks, TypeScript.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [frontend, scaffold, react, firebase]
---
# scaffold-react-app {Frontend} (v1.0)
> **"Ship pixels that perform, accessible by default."**
## Purpose
React 19+ project with Firebase integration. Routing (React Router v7), Auth context, Firestore hooks, TypeScript.
