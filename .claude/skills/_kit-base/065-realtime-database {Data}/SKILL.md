...
description: Firebase RTDB JSON tree. Listeners (on/once). Presence detection. Fan-out writes. Priority/ordering.
version: 1.0.0
status: production
...
## Purpose
Firebase RTDB JSON tree. Listeners (on/once). Presence detection. Fan-out writes. Priority/ordering.
