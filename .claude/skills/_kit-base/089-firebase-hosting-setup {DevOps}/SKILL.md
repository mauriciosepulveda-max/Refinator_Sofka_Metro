...
description: firebase deploy config. Rewrites for SPA. Redirects. Headers (cache, security). Preview channels. Custom domains.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [devops, firebase-hosting, deploy, cdn, spa]
---
# firebase-hosting-setup {DevOps} (v1.0)
> **"Ship fast, ship safe. Automate everything between git push and production."**
## Purpose
firebase deploy config. Rewrites for SPA. Redirects. Headers (cache, security). Preview channels. Custom domains.
