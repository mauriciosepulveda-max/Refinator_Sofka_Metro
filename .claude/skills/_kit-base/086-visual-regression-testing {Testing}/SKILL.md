...
description: Percy or Chromatic setup. Screenshot comparison. Component visual tests. Responsive breakpoint testing.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [testing, visual-regression, percy, screenshots]
---
# visual-regression-testing {Testing} (v1.0)
> **"Untested code is broken code you haven't discovered yet."**
## Purpose
Percy or Chromatic setup. Screenshot comparison. Component visual tests. Responsive breakpoint testing.
