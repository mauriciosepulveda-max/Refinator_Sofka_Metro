---
name: assumption-log
description: Track and validate assumptions. Format: A-NNN assumption, status (unvalidated/validated/invalidated), evidence tag.
version: 1.0.0
status: production
...
## Purpose
Track and validate assumptions. Format: A-NNN assumption, status (unvalidated/validated/invalidated), evidence tag.
