---
name: spa-routing
description: Client-side routing for React Router v7 or Angular Router. Firebase Hosting rewrites for SPA. Route guards, lazy loading.
version: 1.0.0
status: production
...
## Purpose
Client-side routing for React Router v7 or Angular Router. Firebase Hosting rewrites for SPA. Route guards, lazy loading.
