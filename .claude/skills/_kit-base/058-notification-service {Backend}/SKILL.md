...
description: FCM push notifications (topics, data messages). Email via SendGrid/Mailgun. In-app notifications via Firestore.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [backend, notifications, fcm, push, email]
---
# notification-service {Backend} (v1.0)
> **"Firebase Functions are your backend. Design them like microservices, deploy them like magic."**
## Purpose
FCM push notifications (topics, data messages). Email via SendGrid/Mailgun. In-app notifications via Firestore.
