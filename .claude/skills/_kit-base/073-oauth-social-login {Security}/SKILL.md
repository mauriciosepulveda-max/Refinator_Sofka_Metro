...
description: Google Sign-In, Facebook Login, GitHub OAuth, Apple Sign-In. Provider linking. Account conflict handling.
version: 1.0.0
status: production
...
## Purpose
Google Sign-In, Facebook Login, GitHub OAuth, Apple Sign-In. Provider linking. Account conflict handling.
