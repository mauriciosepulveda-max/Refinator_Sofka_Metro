---
name: file-storage
description: Firebase Cloud Storage. Upload with progress. Security rules. Image processing triggers (resize, watermark, thumbnails).
version: 1.0.0
status: production
owner: Javier Montaño
tags: [backend, storage, upload, image-processing]
---
# file-storage {Backend} (v1.0)
> **"Firebase Functions are your backend. Design them like microservices, deploy them like magic."**
## Purpose
Firebase Cloud Storage. Upload with progress. Security rules. Image processing triggers (resize, watermark, thumbnails).
