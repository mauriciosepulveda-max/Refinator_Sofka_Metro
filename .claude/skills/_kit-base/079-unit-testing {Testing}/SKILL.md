---
name: unit-testing
description: Jest/Vitest setup. Firebase emulator unit tests. Mocking Firebase services. Coverage > 80%. TDD workflow.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [testing, unit, jest, vitest, tdd]
---
# unit-testing {Testing} (v1.0)
> **"Untested code is broken code you haven't discovered yet."**
## Purpose
Jest/Vitest setup. Firebase emulator unit tests. Mocking Firebase services. Coverage > 80%. TDD workflow.
