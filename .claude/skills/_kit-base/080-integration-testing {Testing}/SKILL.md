...
description: Firebase Emulator Suite integration tests. Firestore rules testing. Cloud Functions testing. Auth flow testing.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [testing, integration, emulator, rules]
---
# integration-testing {Testing} (v1.0)
> **"Untested code is broken code you haven't discovered yet."**
## Purpose
Firebase Emulator Suite integration tests. Firestore rules testing. Cloud Functions testing. Auth flow testing.
