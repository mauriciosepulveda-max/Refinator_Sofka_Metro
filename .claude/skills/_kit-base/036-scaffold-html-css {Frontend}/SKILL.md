...
description: Production HTML5/CSS3/JS project scaffold. Semantic structure, responsive grid, design tokens, Hostinger-ready deployment.
version: 1.0.0
status: production
...
## Purpose
Production HTML5/CSS3/JS project scaffold. Semantic structure, responsive grid, design tokens, Hostinger-ready deployment.
