...
description: RBAC via custom claims. Admin SDK setCustomUserClaims. Firestore rules request.auth.token. Role hierarchy design.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [security, rbac, custom-claims, authorization]
---
# role-based-access {Security} (v1.0)
> **"Security is not a feature. It's every feature's foundation."**
## Purpose
RBAC via custom claims. Admin SDK setCustomUserClaims. Firestore rules request.auth.token. Role hierarchy design.
