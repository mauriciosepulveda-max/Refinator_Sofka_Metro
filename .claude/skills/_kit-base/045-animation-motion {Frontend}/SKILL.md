...
description: CSS transitions and animations. @keyframes, scroll-driven animations, View Transitions API, Lottie integration.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [frontend, animation, css, motion]
---
# animation-motion {Frontend} (v1.0)
> **"Ship pixels that perform, accessible by default."**
## Purpose
CSS transitions and animations. @keyframes, scroll-driven animations, View Transitions API, Lottie integration.
