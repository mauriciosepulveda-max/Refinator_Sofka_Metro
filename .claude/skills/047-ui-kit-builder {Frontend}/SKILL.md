---
name: ui-kit-builder
description: Design-token-driven UI kit. Button, Card, Modal, Table, Nav, Badge, Toast components. Theme switching support.
version: 1.0.0
status: production
...
## Purpose
Design-token-driven UI kit. Button, Card, Modal, Table, Nav, Badge, Toast components. Theme switching support.
