...
description: Third-party + Google API integration patterns. Payment gateways, email services, maps, analytics.
version: 1.0.0
status: production
...
## Purpose
Third-party + Google API integration patterns. Payment gateways, email services, maps, analytics.
