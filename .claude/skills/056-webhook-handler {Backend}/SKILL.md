...
description: Webhook receiver/sender patterns. Signature verification (Stripe, GitHub). Idempotency keys. Response formatting.
version: 1.0.0
status: production
...
## Purpose
Webhook receiver/sender patterns. Signature verification (Stripe, GitHub). Idempotency keys. Response formatting.
