...
description: Firestore seed scripts. Mock data generators (Faker). Fixture files. Factory pattern for test entities.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [testing, test-data, factory, seed, fixtures]
---
# test-data-factory {Testing} (v1.0)
> **"Untested code is broken code you haven't discovered yet."**
## Purpose
Firestore seed scripts. Mock data generators (Faker). Fixture files. Factory pattern for test entities.
