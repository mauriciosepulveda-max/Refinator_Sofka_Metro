...
description: Transform requirements into user stories. As a role, I want capability, so that benefit. Given/When/Then acceptance criteria.
version: 1.0.0
status: production
...
## Purpose
Transform requirements into user stories. As a role, I want capability, so that benefit. Given/When/Then acceptance criteria.
