...
description: Angular 18+ with AngularFire. Standalone components, signals, guards, services, interceptors, lazy routes.
version: 1.0.0
status: production
...
## Purpose
Angular 18+ with AngularFire. Standalone components, signals, guards, services, interceptors, lazy routes.
