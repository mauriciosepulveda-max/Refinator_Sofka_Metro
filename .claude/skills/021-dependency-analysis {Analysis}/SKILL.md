...
description: Map project dependencies. Critical path. Integration touchpoints. External service deps. Circular dependency detection.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [analysis, dependencies, critical-path, integration]
---
# dependency-analysis {Analysis} (v1.0)
> **"Analyze with evidence. Every claim tagged. Every finding actionable."**
## Purpose
Map project dependencies. Critical path. Integration touchpoints. External service deps. Circular dependency detection.
