...
description: React component library with Storybook. TypeScript interfaces, Jest/Testing Library tests, compound components.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [frontend, react, storybook, components]
---
# react-component-library {Frontend} (v1.0)
> **"Ship pixels that perform, accessible by default."**
## Purpose
React component library with Storybook. TypeScript interfaces, Jest/Testing Library tests, compound components.
