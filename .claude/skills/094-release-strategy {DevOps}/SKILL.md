...
description: Semantic versioning. Conventional commits. Auto-changelog. Feature flags (Firebase Remote Config). Rollback procedures.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [devops, release, versioning, changelog, feature-flags]
---
# release-strategy {DevOps} (v1.0)
> **"Ship fast, ship safe. Automate everything between git push and production."**
## Purpose
Semantic versioning. Conventional commits. Auto-changelog. Feature flags (Firebase Remote Config). Rollback procedures.
