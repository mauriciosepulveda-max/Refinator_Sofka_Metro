...
description: Product vision and roadmap. Feature prioritization (MoSCoW/RICE). Value stream mapping. Google ecosystem positioning.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [analysis, product, roadmap, prioritization]
---
# product-strategy {Analysis} (v1.0)
> **"Analyze with evidence. Every claim tagged. Every finding actionable."**
## Purpose
Product vision and roadmap. Feature prioritization (MoSCoW/RICE). Value stream mapping. Google ecosystem positioning.
