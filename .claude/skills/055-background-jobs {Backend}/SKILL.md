...
description: Cloud Tasks for deferred work. Pub/Sub event-driven. Scheduled functions (cron). Retry policies. Dead letter queues.
version: 1.0.0
status: production
owner: Javier Montaño
tags: [backend, background, cloud-tasks, pubsub, scheduled]
---
# background-jobs {Backend} (v1.0)
> **"Firebase Functions are your backend. Design them like microservices, deploy them like magic."**
## Purpose
Cloud Tasks for deferred work. Pub/Sub event-driven. Scheduled functions (cron). Retry policies. Dead letter queues.
