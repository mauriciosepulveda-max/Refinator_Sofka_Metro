...
| NOMBRE DE HISTORIA DE USUARIO (Nombre que dé una noción general de lo que se quiere desarrollar) | HU Configuración Parametrización de pólizas Protección Financiera para independientes 1000243 y 1000244 de Finandina. |
| :---- | :---- |
...
| Yo Como (“Como” \[perfil\]”: ¿para quién desarrollamos esto? No solo buscamos un cargo, buscamos el perfil de la persona.) | Canales Alternativos- Financial / Directora de Implementación |
| :---- | :---- |
| **Quiero** (aquí describimos su intención) | Quiero contar con la parametrización de producto (planes) de protección Financiera voluntario 1000243 y 1000244\.  |
| **Para (Propósito / Beneficio)** (¿cómo encaja su deseo inmediato de hacer algo en la perspectiva general? ¿Cuál es el beneficio general que intentan lograr? ¿Cuál es el gran problema que debe resolverse?) | Vender pólizas de desempleo voluntario con tasa más competitiva y masificar el negocio. |
...
1. Se requiere parametrizar las Caratulas de Protección Financiera para Independientes con sus respectivas condiciones según DECK
...
4. La información para parametrizar estos productos se encuentra en SIPA en el siguiente enlace:
   ...
   [Deck Ola 2 Finandina Desempleo 29122025.xlsx](https://sbseguros.sharepoint.com/:x:/r/Sites/Innovacion/sipa/Definiciones%20y%20requerimientos/1.%20Parametrizaci%C3%B3n%20de%20productos/FINANDINA/Deck%20Ola%202%20Finandina%20%20Desempleo%2029122025.xlsx?d=w9ad6a2bf3b8c428c873a53f9f9df0ca5&csf=1&web=1&e=qmGHYk)

5. Los textos PDF aplicables a cada producto/caratula son los indicados en la siguiente ruta

   [20250205\_TEXTOS Protección Financiera \-Independientes.docx](https://sbseguros.sharepoint.com/:w:/r/Sites/Innovacion/sipa/Definiciones%20y%20requerimientos/1.%20Parametrizaci%C3%B3n%20de%20productos/FINANDINA/Textos/20250205_TEXTOS%20Protecci%C3%B3n%20Financiera%20-Independientes.docx?d=w07ae4070b2fc4cf0935c0d4185fda72e&csf=1&web=1&e=hSN6Oa)

   

6. El valor asegurado será el valor de la cuota reportado por el Sponsor y este se mantendrá por la vigencia de la financiación, que será reportado por Finandina en el reporte mensual de facturación (ingesta)   
7. Para la Caratula 1000243 Protección Financiera – vehículo, el valor de prima se realizará por Tasa de acuerdo con el Deck, según el valor asegurado en el reportado por Finandina.   
8. Para la Caratula 1000244 Protección Financiera – TC, el valor de prima será fijo de acuerdo con Deck.  
9. Se debe usar el template de Desempleo para ambas caratulas.   
10. Confirmación póliza SISE. 

| POLIZA SISE | INICIO VIGENCIA | FIN DE VIGENCIA |
| :---: | :---: | :---: |
| 1000243 | 1/01/2026 | 1/01/2031 |
| 1000244 | 1/01/2026 | 1/01/2031 |
...
- El agente ya existe en SIPA Banca 
